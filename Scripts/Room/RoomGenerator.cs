...
public class RoomGenerator : MonoBehaviour
{
    ...
    private float main_y; // y стартовой комнаты
    private float main_x; // x стартовой комнаты
    public DoorDeleter[,] field;
    public int size; // Размер стороны квадрата
    ...
    {
        size = calculateSize();
        count_rooms -= 5; // Вычитаем те комнаты, которые уже есть
        main_y = main_room.transform.position.y; // Запоминаем координаты стартовой комнаты
