...
{
    public List<GameObject> enemy_types; // Типы врагов
    public List<GameObject> spawnpoints; // Возможные точки спавна
    private GameObject spawnpoint;
    private bool spawned = false; // Были ли в данной комнате созданы враги
